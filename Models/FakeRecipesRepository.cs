    ...
    public class FakeRecipesRepository
    {
        private static List<Recipe> recipes = new List<Recipe>
        {
            new Recipe {
                ...
                Description = "Tasty turkey takes center stage with cilantro-lime rice as its co-star. The Avocado Pico de Gallo makes a great extra in this soon-to-be award winning dish!",
