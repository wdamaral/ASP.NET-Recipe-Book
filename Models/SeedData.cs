    ...
    public class SeedData
    {
        public static void EnsurePopulated(IApplicationBuilder app)
        {
            ...
            new Recipe
            {
                ...
                Description = "Meatloaf Monster with Gory Tomato Sauce and super easy to cook",
            ...
            new Recipe
            {
                ...
                Description = "Spooky Eyeball Donuts to make during the Halloween time",
            ...
            new Recipe
            {
                PictureUrl = "https://assets.epicurious.com/photos/5bfebc7ecbab3d17dbafd6f5/6:4/w_620%2Ch_413/20181126_GOLIVE_317.jpg",
                RecipeName = "Hanukkah Chicken",
                Description = "One large potato pancake sliced into wedges is an easy large-format alternative to making individual latkes. Serve them alongside applesauce-braised chicken thighs for a holiday dinner.",
                Ingredients = "1 small tube black gel icing, - 1 small tube red gel icing, - 12 Compliments Mini Sugar Donuts , - 6 Swedish berry candies, - 6 mini licorice allsorts (round ones)",
                PrepareMode = "Pipe black gel icing on 6 donuts to resemble black “blood veins” in spooky eyeballs. Pipe red gel icing on the remaining 6 donuts to resemble red “blood veins” in spooky bloodshot eyeballs.  Place berry candies (flat-side up) as “irises” in the centre of the 6 donuts with black gel veins. Pipe a black gel dot in the centre of the candies for pupils.  Place a licorice candy in the centre of the 6 red gel decorated donuts.",
                TimeToPrepare = 75,
                DateAdded = DateTime.Now
            ...
            new Recipe
            {
                PictureUrl = "https://assets.epicurious.com/photos/5c000c65b9a90d10c1e5eb03/6:4/w_620,h_413,c_limit/Molasses-Sandwich-Cookies-with-Coffee-Buttercream-process-12112018.jpg",
                RecipeName = "Christmas Cookies",
                Description = "The cookies take holiday flavors and amp them up to 11.",
                Ingredients = "1 small tube black gel icing, - 1 small tube red gel icing, - 12 Compliments Mini Sugar Donuts , - 6 Swedish berry candies, - 6 mini licorice allsorts (round ones)",
                PrepareMode = "Pipe black gel icing on 6 donuts to resemble black “blood veins” in spooky eyeballs. Pipe red gel icing on the remaining 6 donuts to resemble red “blood veins” in spooky bloodshot eyeballs.  Place berry candies (flat-side up) as “irises” in the centre of the 6 donuts with black gel veins. Pipe a black gel dot in the centre of the candies for pupils.  Place a licorice candy in the centre of the 6 red gel decorated donuts.",
                TimeToPrepare = 100,
                DateAdded = DateTime.Now
            ...
            new Recipe
            {
                PictureUrl = "https://assets.epicurious.com/photos/5a68f342d011da3374a2ce93/6:4/w_620%2Ch_413/Instant-Pot-Choucroute-Garnie-03012018.jpg",
                RecipeName = "Instant Pot Choucroute Garnie",
                Description = "A hearty bistro-ish dinner is unexpected but totally doable this way. The meat is fork-tender, and its fat virtually melts away, adding richness to the sauerkraut and cabbage.",
                Ingredients = "1 small tube black gel icing, - 1 small tube red gel icing, - 12 Compliments Mini Sugar Donuts , - 6 Swedish berry candies, - 6 mini licorice allsorts (round ones)",
                PrepareMode = "Pipe black gel icing on 6 donuts to resemble black “blood veins” in spooky eyeballs. Pipe red gel icing on the remaining 6 donuts to resemble red “blood veins” in spooky bloodshot eyeballs.  Place berry candies (flat-side up) as “irises” in the centre of the 6 donuts with black gel veins. Pipe a black gel dot in the centre of the candies for pupils.  Place a licorice candy in the centre of the 6 red gel decorated donuts.",
                TimeToPrepare = 15,
                DateAdded = DateTime.Now
